...
class ProductsApi
{
     ...
     * Create
     *
     * @param  \BillaBear\Model\Product $body body (required)
     *
     ...
     * Create
     *
     * @param  \BillaBear\Model\Product $body (required)
     *
     * @throws \BillaBear\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    {
        list($response) = $this->listProductWithHttpInfo($limit, $last_key, $name);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listProductAsync($limit = null, $last_key = null, $name = null)
    {
        return $this->listProductAsyncWithHttpInfo($limit, $last_key, $name)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function listProductRequest($limit = null, $last_key = null, $name = null)
    {
    ...
    {
        list($response) = $this->showProductByIdWithHttpInfo($product_id);
        return $response;
    }

    /**
     * Operation showProductByIdWithHttpInfo
     *
     * Detail
     *
     * @param  string $product_id The id of the product to retrieve (required)
     ...
     * @throws \BillaBear\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BillaBear\Model\Product, HTTP status code, HTTP response headers (array of strings)
     */
    public function showProductByIdWithHttpInfo($product_id)
    {
        $returnType = '\BillaBear\Model\Product';
        $request = $this->showProductByIdRequest($product_id);
    ...
    /**
     * Operation showProductByIdAsync
     *
     * Detail
     *
     * @param  string $product_id The id of the product to retrieve (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function showProductByIdAsync($product_id)
    {
        return $this->showProductByIdAsyncWithHttpInfo($product_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation showProductByIdAsyncWithHttpInfo
     *
     * Detail
     *
     * @param  string $product_id The id of the product to retrieve (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function showProductByIdAsyncWithHttpInfo($product_id)
    {
        $returnType = '\BillaBear\Model\Product';
        $request = $this->showProductByIdRequest($product_id);
    ...
    /**
     * Create request for operation 'showProductById'
     *
     * @param  string $product_id The id of the product to retrieve (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function showProductByIdRequest($product_id)
    {
        // verify the required parameter 'product_id' is set
        if ($product_id === null || (is_array($product_id) && count($product_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $product_id when calling showProductById'
            );
        }
    ...
    {
        list($response) = $this->updateProductWithHttpInfo($product_id);
        return $response;
    }
     ...
     * @return array of \BillaBear\Model\Product, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateProductWithHttpInfo($product_id)
    {
        $returnType = '\BillaBear\Model\Product';
        $request = $this->updateProductRequest($product_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateProductAsync($product_id)
    {
        return $this->updateProductAsyncWithHttpInfo($product_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateProductAsyncWithHttpInfo($product_id)
    {
        $returnType = '\BillaBear\Model\Product';
        $request = $this->updateProductRequest($product_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateProductRequest($product_id)
    {
        // verify the required parameter 'product_id' is set
        if ($product_id === null || (is_array($product_id) && count($product_id) === 0)) {
            throw new \InvalidArgumentException(
